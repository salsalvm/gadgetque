...
CategoryDatasModel categoryDatasModelFromJson(String str) => CategoryDatasModel.fromJson(json.decode(str));

String categoryDatasModelToJson(CategoryDatasModel data) => json.encode(data.toJson());
...
class CategoryDatasModel {
    ...
    factory CategoryDatasModel.fromJson(Map<String, dynamic> json) => CategoryDatasModel(
        prodata: List<Prodatum>.from(json["prodata"].map((x) => Prodatum.fromJson(x))),
        cat: json["cat"],
        cartCount: json["cartCount"],
    );
